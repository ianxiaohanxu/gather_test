...
class Visit(Case):
    ...
    def full_fill_visit(self):
        ...
        self.enter_data('15.0', data.PR_PATIENT_RECORD_VISIT_HDL, data.PR_PATIENT_RECORD_VISIT_HDL_CONFIRM)
        self.enter_data('15.0', data.PR_PATIENT_RECORD_VISIT_LDL, data.PR_PATIENT_RECORD_VISIT_LDL_CONFIRM)
        self.enter_data('5.0', data.PR_PATIENT_RECORD_VISIT_VLDL, data.PR_PATIENT_RECORD_VISIT_VLDL_CONFIRM)
        self.enter_data('15.0', data.PR_PATIENT_RECORD_VISIT_TRI, data.PR_PATIENT_RECORD_VISIT_TRI_CONFIRM)
        ...
        self.verify_data('15', data.PR_PATIENT_RECORD_VISIT_HDL)
        self.verify_data('15', data.PR_PATIENT_RECORD_VISIT_LDL)
        self.verify_data('5.0', data.PR_PATIENT_RECORD_VISIT_VLDL)
        self.verify_data('15', data.PR_PATIENT_RECORD_VISIT_TRI)
