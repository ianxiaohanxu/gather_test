...
class Payment(unittest.TestCase):
    ...
    def test_extend_subscriptioin_with_premium(self):
        ...
        self.pr.wait_until_not(data.PR_PATIENT_RECORD_BILLING_P_CONFIRM)
    ...
    def test_extend_subscriptioin_with_free_trial(self):
        ...
        self.pr.wait_until_not(data.PR_PATIENT_RECORD_BILLING_F_CONFIRM)
        self.assertFalse(self.pr.focus(data.PR_PATIENT_RECORD_BILLING_MONTH_RATE).is_enabled())
        self.pr.click(data.PR_PATIENT_RECORD_BILLING_SUBMIT)
    ...
    def test_void_premium_entry(self):
        ...
        self.pr.wait_until_not(data.PR_PATIENT_RECORD_BILLING_V_CONFIRM)
    ...
    def test_void_free_trial_entry(self):
