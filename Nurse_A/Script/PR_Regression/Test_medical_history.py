...
class Medical_history(Case):
    ...
    def fill_all_data(self, gender, dob, dia_type, other_str, year):
        ...
        self.pr.select(year, data.PR_PATIENT_RECORD_MEDICAL_HISTORY_TYPE_YEAR)
    ...
    def verify_data(self, gender, dob, dia_type, other_str, year):
        ...
        self.assertEqual(year, self.pr.text(data.PR_PATIENT_RECORD_MEDICAL_HISTORY_TYPE_YEAR))
    ...
    def data_sync_check(self, gender, dob, dia_type, year):
        ...
        year = str(datetime.datetime.now().year - int(year))
    ...
    def test_normal_data_sync(self):
        ...
        self.pr.click(data.PR_PATIENT_RECORD_MEDICAL_HISTORY)
        self.pr.verify(data.PR_PATIENT_RECORD_MEDICAL_HISTORY_GENDER)
        self.data_sync_check('0', '1986-07-08', '0', '2010')
        self.data_sync_check('1', '1986-07-08', '1', '2010')
        self.data_sync_check('2', '1986-07-08', '2', '2010')
        self.data_sync_check('0', '1986-07-08', '3', '2010')
        self.data_sync_check('0', '1986-07-08', '4', '2010')
